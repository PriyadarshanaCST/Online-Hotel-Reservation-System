			...
			<div class="container-fluid">
			 <h4 class="sub-header">Dashboard</h4>
				<div class="row">	
					<?php
					include './auth.php';
					$re = mysqli_query($con,"select count(booking_id) as total_row from hallbooking WHERE DATEDIFF(NOW(), booking_date) <= 7;");
					$re2 = mysqli_query($con,"select count(booking_id) as total_row from hallbooking WHERE payment_status like 'NULL%';");
					$re3 = mysqli_query($con,"select count(booking_id) as total_row from hallbooking WHERE payment_status like 'Conf%';");
				...
				<?php include './auth.php';
					$re = mysqli_query($con,"select * from hallbooking WHERE DATEDIFF(NOW(), booking_date) <= 7 ;");
					if(mysqli_num_rows($re) > 0){
								while ($row = mysqli_fetch_array($re) ){
											print "<tr style=\"\">		 <td>".$row['booking_id']."</td>\n";
											print "                  <td>".$row['hall_id']."</td>\n";
					 ...
					 <hr>       <div class="col-xs-12 "  >
							  ...
							  <div class="table-responsive">
								<table class="table table-striped">
								  ...
								  <tbody id="info1"  >
				<?php include './auth.php';
					$re = mysqli_query($con,"select * from hallbooking WHERE payment_status like 'pending%';");
					if(mysqli_num_rows($re) > 0){
								while ($row = mysqli_fetch_array($re) ){
									print "<tr style=\"\">		 <td>".$row['booking_id']."</td>\n";
									print "                  <td>".$row['hall_id']."</td>\n";
					      ...
					      <hr>  <div class="col-xs-12 "  >
							  ...
							  <div class="table-responsive">
								<table class="table table-striped">
								  ...
								  <tbody id="info2"  >
				<?php include './auth.php';
					$re = mysqli_query($con,"select * from hallbooking WHERE payment_status like 'conf%';");
					if(mysqli_num_rows($re) > 0){
								while ($row = mysqli_fetch_array($re) ){
									print "<tr style=\"\">		 <td>".$row['booking_id']."</td>\n";
									print "                  <td>".$row['hall_id']."</td>\n";
