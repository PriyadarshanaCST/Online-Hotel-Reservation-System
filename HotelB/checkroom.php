      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Book Now<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="addroom.php">Rooms</a></li>
           <li><a href="addhall.php">Reciption Hall</a></li>
...
<div class="row foo" style="margin:60px auto 0px auto;">
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			...
			<p class="fontgrey">Reservation omplete</p>
		</div>
</div>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding:10px">
		...
		<div class="large-12 columns" >
			<?php
				...
				$result = mysqli_query($con,"SELECT r.room_id, (r.total_room-br.total) as availableroom from room as r LEFT JOIN (SELECT roombook.room_id, sum(roombook.totalroombook) as total from roombook where roombook.booking_id IN 
(SELECT b.booking_id as bookingID from booking as b where (b.checkin_date between '".$datestart."' AND '".$dateend."') OR (b.checkout_date between '".$dateend."' AND '".$datestart."'))group by roombook.room_id)as br ON r.room_id = br.room_id");
				//echo mysqli_error();
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : LKR </span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Rate : LKR </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\">/ night</span><br>\n";
